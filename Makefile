...
$(LOGGER_TEST_NAME): $(LOGGER_TEST_OBJ)
	${GCC} $(CFLAGS) $(INCL_DIR) $(LOGGER_TEST_OBJ) $(LIB_NAME) -o $(LOGGER_TEST_NAME) -lrt -pg -lgcov

$(SHM_TRANSPORT_NAME): $(SHM_TRANSPORT_OBJ)
	${GCC} $(CFLAGS) $(INCL_DIR) $(SHM_TRANSPORT_OBJ) $(LIB_NAME) o $(SHM_TRANSPORT_NAME) -lrt -pg -lgcov
